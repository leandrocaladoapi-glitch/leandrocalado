...
export const translations: Record<Language, TranslationDict> = {
  pt: {
    ...
    articles: {
      ...
      newsletterTitle: "Newsletter: Safe AI, Law & Data",
      newsletterDesc: "Safe AI, dados e automação para negócios, tecnologia e direito. Uma newsletter escrita quinzenalmente por Leandro Calado sobre agentes de IA, engenharia de dados e prompts estratégicos. Conta com mais de 1.559 assinantes.",
      newsletterCta: "Inscrever-se no LinkedIn",
    },
    timeline: {
  ...
  en: {
    ...
    articles: {
      ...
      newsletterTitle: "Newsletter: Safe AI, Law & Data",
      newsletterDesc: "Safe AI, data, and automation for business, technology, and law. A biweekly newsletter by Leandro Calado about AI agents, data engineering, and prompt design. Currently has 1,559 subscribers.",
  ...
  es: {
    ...
    articles: {
      ...
      newsletterTitle: "Boletín: Safe AI, Law & Data",
      newsletterDesc: "Safe AI, datos y automatización para empresas, tecnología y derecho. Un boletín quincenal de Leandro Calado sobre agentes de IA, ingeniería de datos y diseño de prompts. Cuenta con 1.559 suscriptores.",
  ...
  fr: {
    ...
    articles: {
      ...
      newsletterTitle: "Newsletter: Safe AI, Law & Data",
      newsletterDesc: "Safe AI, données et automatisation pour les entreprises, la technologie et le droit. Une newsletter bimensuelle de Leandro Calado sur les agents d'IA, l'ingénierie des données et les invites (prompts). Suivie par 1 559 abonnés.",
  ...
  it: {
    ...
    articles: {
      ...
      newsletterTitle: "Newsletter: Safe AI, Law & Data",
      newsletterDesc: "Safe AI, dati e automazione per business, tecnologia e diritto. Una newsletter bisettimanale di Leandro Calado su agenti di IA, ingegneria dei dati e prompt design. Con 1.559 iscritti.",
  ...
  ja: {
    ...
    articles: {
      ...
      claps: "拍手",
      readCta: "元の記事を読む",
      newsletterTitle: "ニュースレター: Safe AI, Law & Data",
      newsletterDesc: "ビジネス、テクノロジー、法務のための安全なAI、データ、自動化。AIエージェント、データエンジニアリング、プロンプト設計について、レアンドロ・カラードが隔週で配信中。登録者数1,559名。",
