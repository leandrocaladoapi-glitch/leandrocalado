...
const slug = 'ai-agent-whistleblowing-harness-engineering';
...
console.log(`Validated ${langs.length} whistleblowing explainers, hubs, hreflang, sitemap, schemas and WebP (${dimensions.join('x')}, ${bytes.length} bytes).`);
